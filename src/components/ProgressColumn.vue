<template>
    <div id="row" class="bg-base-300 rounded-xl overflow-auto flex flex-col">
        <div id="row-headline" class="px-4 py-2 flex gap-2 items-center sticky top-0 bg-base-300">
            ...
            <div class="grow" />
            <button class="flex justify-center items-center gap-1 w-6">
        ...
        <button class="w-full py-1 bg-base-300 rounded-xl border border-transparent hover:border-primary sticky bottom-0">
            + Add Item
        </button>
    </div>
</template>
